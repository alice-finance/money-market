...
contract("DelegatedSavings", function([owner, user1, user2, user3, user4, not_allowed_user, insufficient_user]) {
  ...
  context("saving", function() {
    context("deposit", function() {
      ...
      it("should not deposit when ERC20.transferFrom() fails", async function() {
        ...
        await market.initialize(this.calculator.address, MINIMUM_SAVINGS_AMOUNT);
